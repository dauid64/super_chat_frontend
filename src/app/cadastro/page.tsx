    ...
    return (
        <div className="h-screen flex items-center justify-center">
            <div className="flex flex-col items-center justify-center shadow-md h-3/4 w-3/4 xl:w-1/2 bg-gradient-to-b from-indigo-300 to-yellow-200 rounded-lg">
                ...
                <form className="flex flex-col w-3/4" onSubmit={(e) => Register(e)}>
                    <AuthInput
                        label="E-mail" 
                        tipo="email"
                        onChange={setEmail}
                    ...
                    <AuthInput
                        ...
                        obrigatorio
                    ></AuthInput>
                    <span className="text-gray-950 text-sm md:text-lg mt-2">Caso já tenha uma conta, <a className="text-blue-600 underline-offset-2 hover:text-blue-500 text-xs md:text-base" href="/login">clique aqui!</a></span>
                    <button 
